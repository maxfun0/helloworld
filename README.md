...
1. Clone this repo:
	...
	git clone --depth=1 https://github.com/maxfun0/helloworld.git package/helloworld
	```
...
1. Add new submodule:
	...
	```bash
	rm -rf package/helloworld
	git submodule add -f --name helloworld https://github.com/maxfun0/helloworld.git package/helloworld
	```
